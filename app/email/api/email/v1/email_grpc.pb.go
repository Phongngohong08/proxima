...
const (
	Email_SendEmail_FullMethodName = "/email.v1.Email/SendEmail"
)
...
func (c *emailClient) SendEmail(ctx context.Context, in *SendEmailReq, opts ...grpc.CallOption) (*SendEmailRes, error) {
...
func (UnimplementedEmailServer) SendEmail(context.Context, *SendEmailReq) (*SendEmailRes, error) {
